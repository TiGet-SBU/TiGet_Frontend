...
namespace Rhazes.Services.Identity.API.Infrastructure.Certificates
{
    static class Certificate
    {
        public static X509Certificate2 Get()
        {
             ...
             **********************************************************************************************/
            using (var stream = assembly.GetManifestResourceStream("Rhazes.Services.Identity.API.Infrastructure.Certificate.RhazesIdpSigningCert.pfx"))
            {
                return new X509Certificate2(ReadStream(stream), "Rhazes");
            }
        }
        ...
        private static X509Certificate2 loadCertificateFromFile()
        {
            ...
            var certificate = new X509Certificate2(
                fileName: Path.Combine(Directory.GetCurrentDirectory(), "wwwroot", "app_data", "RhazesIdpSigningCert"),
                password: "Rhazes",
